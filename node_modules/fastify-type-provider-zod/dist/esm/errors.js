...
var InvalidSchemaError = createError("FST_ERR_INVALID_SCHEMA", "Invalid schema passed: %s", 500);
var ZodFastifySchemaValidationErrorSymbol = Symbol.for("ZodFastifySchemaValidationError");
var ResponseSerializationBase = createError("FST_ERR_RESPONSE_SERIALIZATION", "Response doesn't match the schema", 500);
...
//#endregion
export { InvalidSchemaError, ResponseSerializationError, createValidationError, hasZodFastifySchemaValidationErrors, isResponseSerializationError };
