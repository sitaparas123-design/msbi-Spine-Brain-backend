...
export declare const zodSchemaToJson: (zodSchema: $ZodType, registry: $ZodRegistry<SchemaRegistryMeta>, io: "input" | "output", config: ZodToJsonConfig) => JSONSchema.BaseSchema;
